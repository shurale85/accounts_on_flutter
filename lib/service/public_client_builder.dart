...
/// Authentication and authorization builder for MS Azure auth20 provider
class PublicClientBuilder {
  ...
  static PublicClientApplication build() {
    _publicClientApp = PublicClientApplication(Configuration()
      ..auth = (BrowserAuthOptions()
        ..clientId = clientId
        ..authority =
            'https://login.microsoftonline.com/flutterback.onmicrosoft.com'
