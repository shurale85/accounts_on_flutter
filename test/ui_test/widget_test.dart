...
void main() {
  ...
  testWidgets('ContentView shows content', (WidgetTester tester) async {
    ...
    .thenReturn(Account.accounts);
    when(networkServiceMock.getIsLoading())
    .thenReturn(false);
   ...
   testWidgets('ContentView shows preloader while API request is ongoing', (WidgetTester tester) async {
     when(repositoryMock.getData())
         .thenReturn(Account.accounts);
     when(networkServiceMock.getIsLoading())
         .thenReturn(true);
   ...
   testWidgets('ContentView displays No account found when no account', (WidgetTester tester) async {
